...
| dataset       |       dataset size | training steps |        AP       | ${AP}^{IoU=.50}^$ | ${AP}^{IoU=.75}^$ | ${AP}^{large}^$ | ${AP}^{medium}^$ |   |
|---------------|-------------------:|---------------:|:---------------:|:-----------------:|:-----------------:|:---------------:|:----------------:|:-:|
...
|               |              64115 |         577008 |    **65.12**    |     **86.73**     |     **70.97**     |    **72.64**    |     **61.15**    |   |
| Synth dataset | 4.9 $\times$ 10^3^ |                |   1.89 ± 0.29   |    4.64 ± 0.31    |    1.26 ± 0.29    |   1.92 ± 0.30   |    2.22 ± 0.15   |   |
|               |   ${49}\times10^3$ |                | **5.47 ± 0.10** |  **11.77 ± 0.28** |  **4.54 ± 0.19**  | **5.50 ± 0.44** |  **6.42 ± 0.16** |   |
|               |  ${245}\times10^3$ |                |   4.78 ± 0.24   |    9.74 ± 0.55    |    4.05 ± 0.13    |   4.86 ± 0.23   |    5.74 ± 0.32   |   |
|               |  ${490}\times10^3$ |                |   3.97 ± 0.61   |    8.23 ± 1.37    |    3.33 ± 0.50    |   4.27 ± 0.75   |    4.69 ± 0.54   |   |
